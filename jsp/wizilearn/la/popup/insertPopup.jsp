...
<script type="text/javascript">
	...
	function fn_save(){
		var reqUrl = "/la/popup/insertPopup";
...
<form id="frmComPopup" name="frmComPopup" method="post" enctype="multipart/form-data" >
	...
	<div class="title-name-1">팝업 등록</div>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="view-2">
		<tbody>
			<tr>
				...
				<td><input type="text" name="popupTitle" id="popupTitle" value="" style="width:100%;"/></td>
			</tr>
			<tr>
				<th width="100px"><font color="red">*</font>게시 기간</th>
				<td>
					<input type="text" name="ntceBgnde" id="ntceBgnde"  value="" style="width:80px;" /> ~
					<input type="text" name="ntceEndde" id="ntceEndde"  value="" style="width:80px;" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="radio" name="stopviewYn" value="Y" checked/>사용
					<input type="radio" name="stopviewYn" value="N"/>미사용
				</td>
			</tr>
			<tr> 
				<th><font color="red">*</font>팝업 위치</th>
				<td>
					LEFT : <input type="text" id="popupWidthPosi" name="popupWidthPosi" value="" numberOnly=""/>px,   TOP : <input type="text" id="popupHeightPosi" name="popupHeightPosi" value="" numberOnly=""/>px
				</td>
			</tr>
			<tr>
				<th><font color="red">*</font>팝업 사이즈</th>
				<td>
					폭 : <input type="text" id="popupWidthSize" name="popupWidthSize" value="" numberOnly=""/>px,   	높이 : <input type="text" id="popupHeightSize" name="popupHeightSize" value="" numberOnly=""/>px
				</td>
			</tr>
			<tr>
				<th><font color="red">*</font>내용</th>
				<td ><textarea name="popupContent" id="popupContent" style="width:85%;"></textarea></td>
			</tr>
		</tbody>
	</table>
</form>
