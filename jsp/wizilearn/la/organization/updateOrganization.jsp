...
<form id="frmOrganization" name="frmOrganization" method="post" enctype="multipart/form-data">
	...
	<input type="hidden" id="orgImg" name="orgImg" value="${result.orgImg }"/>
	<div class="title-name-1">기관관리 수정</div>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="view-2">
		<tbody>
			...
			<tr>  
				...
				<td><input type="text" id="orgStep" name="orgStep" numberOnly="" value="${result.orgStep}"/></td>
			</tr>
			<tr>
				<th><font color="red">*</font>기관명</th>
				<td><input type="text" id="orgName" name="orgName" value="${result.orgName}" maxlength="40"/></td>
			</tr>
			<tr>
				<th><font color="red">*</font>기관명(전체)</th>
				<td><input type="text" id="orgNameFull" name="orgNameFull" value="${result.orgNameFull}" maxlength="40"/></td>
			</tr>
			<tr>  
				<th><font color="red">*</font>기관 홈페이지</th>
				<td><input type="text" id="orgUrl" name="orgUrl" value="${result.orgUrl}"/></td>
			</tr>  
			<tr>
