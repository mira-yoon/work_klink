...
<body>
	...
	<c:forEach var="dto" items="${list}" varStatus="status">
		...
		<script type="text/javascript">
			var _obj = {};	
			_obj.name = '${dto.nationDTO.natNameKr}';
		  	_obj.y = ${dto.ratio};
		  	_obj.drilldown = null;
	...
	//<![CDATA[
		...
		function changeFromToDate(type) {
			...
			$("#statisticsFrm").attr("action","/la/statistics/nationCourse");
		...
		function saveExcel(){
			...
			document.statisticsFrm.action = '/la/statistics/nationCourseExcelDown';
		...
		function fn_excel(){
			var reqUrl = "/la/statistics/nationCourseExcelDown";
