...
$(document).ready(function() {
	$(document).attr("title","Community > Community > Daily List > Modify : K-LINK");
});

function fn_save(){
	if(confirm("Do you want to register?")){
		var reqUrl = "/lu/community/updateCommunity";
...
$(document).on('focusin focusout', ".upload-hidden", function (e) {
	...
	<div id="write">
		...
		<form id="frmBbs" name="frmBbs" method="post"  enctype="multipart/form-data"  >
			...
			<table>
				<caption class="sr-only">Modify program review</caption>
				<tr>
